...
function Overview() {
    ...
    return (
        <div className="flex flex-col items-center pt-32 ">
            ...
            <div className="flex lg:flex-row flex-col gap-16 lg:gap-0 justify-around items-center w-screen ">
                <div className="flex flex-col gap-4 w-[310px] sm:w-[350px] md:w-[700px] text-justify text-xl">
                ...
                <img src="https://img.freepik.com/free-vector/cyber-security-concept_53876-90448.jpg?w=1380&t=st=1677286275~exp=1677286875~hmac=52dfbbaeb5dd0ef94436b0d7771fe02c37d28e91f1f4ef867385053e3d206fe4" alt="" className="md:w-[700px] md:h-[500px] w-[310px] sm:w-[350px] h-[200px]" />
        </div>

        <div className="flex lg:flex-row-reverse flex-col gap-16 lg:gap-0 justify-around w-screen pt-56 pb-56 items-center">
                <div ref={ref} className="">
                    {fistview && <div className="flex flex-col gap-8 w-[310px] sm:w-[350px] md:w-[700px] text-justify text-xl">
                        <motion.div className=""
                                    initial={{opacity : 0}}
                                    animate={{ opacity : 1}}
                                    transition={{type: 'spring', stiffness: 45, delay: 0.5}}
